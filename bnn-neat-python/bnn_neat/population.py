...
class Population(object):
    ...
    def run(self, fitness_function, n=None):
        ...
        while n is None or k < n:
            ...
            # Check if fitness_function signals to stop early
            if should_stop:
                print("Fitness function requested early stopping.")
                break
            ...
            '''
            # Prune genomes after reproduction (Taking out for now)
            for genome_id, genome in self.population.items():
                # Prune the genome
                pruned_genome = genome.get_pruned_copy(self.config.genome_config)
                # Assign the original key and fitness to the pruned genome
                ...
                self.population[genome_id] = pruned_genome
            '''
