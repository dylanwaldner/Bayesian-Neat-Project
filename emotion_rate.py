...
def ground_truth(text, danger_level=4):
    prompt = f"For each choice, output either 1 (survival) or 0 (death) based on a danger level of {danger_level}/10 (Moderate danger, a wrong move could lead to death or make death more likely later on). Use the format 'Choice __: 1/0'. No explanations or additional text."
