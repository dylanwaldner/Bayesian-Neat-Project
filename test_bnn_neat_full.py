...
def config():
    ...
    config_path = "/scratch/cluster/dylantw/Risto/init/config-feedforward"  # Ensure this file exists in the correct directory
...
def bnn(mock_genome, config):
    ...
    config.genome_config.num_inputs = 7686
